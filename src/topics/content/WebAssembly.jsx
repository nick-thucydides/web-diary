...
const WebAssembly = () => (
  <div>
    ...
    <p className="text-gray-600 mb-6">
      WASM code is way faster and smaller than the JS equivalent. We compile our code once and then use JS to call the WASM functions. We write C/C++ functions, compile them with emscripten, and then import them. WASM is ideal for when we are expecting to deal with some CPU-heavy tasks.
    </p>
...
console.log('Example code');`}</pre>
    ...
    <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mb-6">
      ...
      <ul className="text-gray-700 space-y-2">
        <li>• Can we use WASM without JS why or why not?</li>
